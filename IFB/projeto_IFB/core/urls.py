...
urlpatterns = [
    ...
    path('api/turmas/', views.listar_turmas, name='listar_turmas'),
    path('api/turmas', views.listar_turmas),
    path('api/turma/', views.listar_turmas),
    path('api/turma', views.listar_turmas),
    path('api/cursos/', views.listar_cursos, name='listar_cursos'),
    path('api/cursos', views.listar_cursos),
    path('api/curso/', views.listar_cursos),
    path('api/curso', views.listar_cursos),
